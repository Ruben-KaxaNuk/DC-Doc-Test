...
To add a custom calculation function, you need to copy this file to the Config folder,
...
Once you've added your function to the file, you need to add its name prefixed by c_ to
the Output_Columns sheet of the parameters.xlsx file.
...
def test(m_open, m_close):
    ...
    this file there).
    2. Add c_test to the Output_Columns sheet in the Config/parameters.xlsx file.
